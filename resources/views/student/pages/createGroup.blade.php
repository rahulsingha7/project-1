...
<script type="text/javascript">
    $(document).ready(function () {
        $("#group").change(function () {
            ...
            for (var i = 1; i <= total; i++) {
                ...
                <input type="number" class="form-control form-control-user" id="member_id[]" placeholder="Enter Group Member ID">
                <label for="">Group member Name</label>
                <input type="text" class="form-control form-control-user" id="member_name[]" placeholder="Enter Group Member Name">         
                `;
  ...
  headers: {
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          ...
          var member_id =$("input[number='member_id[]']").map(function(){
            return $(this).val();
          }).get();
